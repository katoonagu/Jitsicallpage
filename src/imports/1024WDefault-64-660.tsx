import svgPaths from "./svg-99v8zxjlwb";
  ...
  return (
    <div className="bg-size-[auto_auto,auto_auto,1280px_613px] bg-top-left relative shrink-0 w-full" data-name="Overlay+Background" style={{ backgroundImage: `linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(0, 0, 0) 0%, rgba(0, 0, 0, 0) 75.16%), url('${imgOverlayBackground}')` }}>
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pb-[16px] pt-[120px] px-[163px] relative w-full">
          <Container />
        </div>
      </div>
    </div>
...
function Footer() {
  return (
    <div className="bg-[#131519] relative shrink-0 w-full" data-name="Footer">
      <div className="content-stretch flex flex-col items-start px-[163px] relative w-full">
        <Container15 />
      </div>
    </div>
  );
...
function Main() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-start left-0 min-h-[640px] right-[10px] top-0" data-name="Main">
      <OverlayBackground />
      <Container8 />
    </div>
  );
...
export default function Component1024WDefault() {
  return (
    <div className="bg-white relative size-full" data-name="1024w default">
      <Main />
    </div>
  );
}