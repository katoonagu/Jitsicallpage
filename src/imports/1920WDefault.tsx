import svgPaths from "./svg-mtl2mb8nxd";

function Blur() {
  return <div className="absolute blur-[20px] h-[1200px] left-0 top-0 w-[1920px]" data-name="Blur" />;
}

function Video() {
  return (
    <div className="absolute content-stretch flex flex-col h-[1200px] items-start justify-center left-0 overflow-clip top-0 w-[1920px]" data-name="Video">
...
function Figure() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] h-[1200px] left-0 overflow-clip shadow-[0px_0px_20px_-2px_#444] top-0 w-[1920px]" data-name="Figure">
      <Video />
    </div>
  );
}
...
function Background() {
  return (
    <div className="absolute bg-[#040404] h-[1200px] left-0 overflow-clip top-0 w-[1920px]" data-name="Background">
      <Blur />
      <Figure />
...
function Container() {
  return (
    <div className="h-[1200px] relative shrink-0 w-full" data-name="Container">
      <Container1 />
      <Background1 />
    </div>
  );
...
export default function Component1920WDefault() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="1920w default" style={{ backgroundImage: "linear-gradient(90deg, rgb(4, 4, 4) 0%, rgb(4, 4, 4) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Main />
    </div>
  );
}