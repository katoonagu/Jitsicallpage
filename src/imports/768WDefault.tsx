import svgPaths from "./svg-sxv84vm1tt";
  ...
  return (
    <div className="bg-size-[auto_auto,auto_auto,1280px_613px] bg-top-left relative shrink-0 w-full" data-name="Overlay+Background" style={{ backgroundImage: `linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(0, 0, 0) 0%, rgba(0, 0, 0, 0) 75.16%), url('${imgOverlayBackground}')` }}>
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pb-[16px] pt-[120px] px-[40px] relative w-full">
          <Container />
        </div>
      </div>
    </div>
...
export default function Component768WDefault() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start pb-[340.58px] relative size-full" data-name="768w default">
      <OverlayBackground />
      <Container8 />
    </div>
  );
